...
send(msg.chat_id_, msg.id_, "◈︙ لا يمكنك حظر مطور الاساسي عام .")
return false 
end
...
send(msg.chat_id_, msg.id_, "◈︙ لا يمكنك حظر المبرمج .")
return false 
end
if tonumber(userid) == tonumber(SUDO) then  
send(msg.chat_id_, msg.id_, "◈︙ لا يمكنك حظر مطور الاساسي .")
return false 
end
