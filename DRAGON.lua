...
sudo_users = {SUDO,1949073317,bot_id}
...
if Json_Info.result.can_chaDRGe_info == true then
info = 'ꪜ'
else
info = '✘'
end
...
if SudoBot(msg) then
local bl =  '-  𝐖𝐄𝐈𝐂𝐎𝐌𝐄 𝐆𝐎𝐆𝐎المطور الاساسي \n سورس جوجو \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/S_16_M) '
local keyboard = {
	{'•معلومات الكيبورد•'},
	  {'•ضع اسم للبوت•'},
...
send(msg.sender_user_id_, msg.id_,' 𝐖𝐄𝐈𝐂𝐎𝐌𝐄 𝐆𝐎𝐆𝐎\n سيتم الرد عليك قريبا')
tdcli_function ({ID = "ForwardMessages", chat_id_ = SUDO,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..striDRG.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
...
if text == 'حظر' then
local Name = '['..striDRG.sub(data.first_name_,0, 40)..'](tg://user?id='..id_user..')'
...
tdcli_function ({ ID = "SendChatAction",chat_id_ = id_user, action_ = {  ID = "SendMessageTypiDRGAction", progress_ = 100} },function(arg,ta) 
...
chat_id_ = pv[i], action_ = {  ID = "SendMessageTypiDRGAction", progress_ = 100} 
},function(arg,data) 
...
tdcli_function ({ID = "ChaDRGeChatMemberStatus",chat_id_=group[i],user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
w = w + 1
end
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'S_16_M')..')'
...
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'S_16_M')..') '
status  = '\n تم ترقيته مطور في البوت'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• العضو> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'S_16_M')..') \n •'..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
return false  end 
database:del(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local username = striDRG.match(text, "@[%a%d_]+") 
tdcli_function ({    
ID = "SearchPublicChat",    
username_ = username  
},function(arg,data) 
...
return false  end 
database:del(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local texxt = striDRG.match(text, "(.*)") 
...
if database:get(bot_id..'ChaDRGe:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) then 
if msg.content_.photo_.sizes_[3] then  
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_ 
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_ 
end 
tdcli_function ({ID = "ChaDRGeChatPhoto",chat_id_ = msg.chat_id_,photo_ = getInputFile(photo_id) }, function(arg,data)   
if data.code_ == 3 then
send(msg.chat_id_, msg.id_,' عذرا البوت ليس ادمن يرجى ترقيتي والمحاوله لاحقا') 
database:del(bot_id..'ChaDRGe:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
return false  end
...
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/S_16_M)}\n•["..DRAGON_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
--------------------------------------------------------------------------------------------------------------
if not Special(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"flood") or 'nil'
NUM_MSG_MAX = database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"floodmax") or 5
TIME_CHECK = database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"flood") 
trigger_anti_spam(msg,type)  
end
database:setex(bot_id..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_, tonumber(database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or 'nil'  
NUM_MSG_MAX = 5
if database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"floodmax") then
NUM_MSG_MAX = database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"floodtime") then
TIME_CHECK = database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
...
for k,v in pairs(list) do
print(striDRG.find(text,v))
if striDRG.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
end
...
local _nl, ctrl_ = striDRG.gsub(text, '%c', '')  
local _nl, real_ = striDRG.gsub(text, '%d', '')   
sens = 400  
if database:get(bot_id.."lock:Spam"..msg.chat_id_) == "del" and striDRG.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."lock:Spam"..msg.chat_id_) == "ked" and striDRG.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."lock:Spam"..msg.chat_id_) == "kick" and striDRG.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."lock:Spam"..msg.chat_id_) == "ktm" and striDRG.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/S_16_M)}\n• الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendText(msg.chat_id_,'\n•بواسطه ← ['..striDRG.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n• تم تفعيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
br = JSON.decode(gk)
send(msg.chat_id_, msg.id_,br.meaniDRG)
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@S_16_M','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
local DRAGONCheDRGName = database:get(bot_id.."DRAGON:CheDRG:Name"..data.id_)
if not data.first_name_ then 
if DRAGONCheDRGName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DRAGONCheDRGName..']')
database:del(bot_id.."DRAGON:CheDRG:Name"..data.id_) 
end
end
if data.first_name_ then 
if DRAGONCheDRGName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."DRAGON:CheDRG:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local DRAGONCheDRGUserName = database:get(bot_id.."DRAGON:CheDRG:UserName"..data.id_)
if not data.username_ then 
if DRAGONCheDRGUserName then 
send(msg.chat_id_, msg.id_, 1, "هذا الشخص حذف معرفه      \n هاذه معرفه  : [@"..DRAGONCheDRGUserName..']')
database:del(bot_id.."DRAGON:CheDRG:UserName"..data.id_) 
end
end
if data.username_ then 
if DRAGONCheDRGUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."DRAGON:CheDRG:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local DRAGONCheDRGPhoto = database:get(bot_id.."DRAGON:CheDRG:Photo"..data.id_)
if not data.profile_photo_ then 
if DRAGONCheDRGPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."DRAGON:CheDRG:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if DRAGONCheDRGPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "ايه الصوره القمر دي ",
...
database:set(bot_id.."DRAGON:CheDRG:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local Text =[[
مرحبا بك في سورس جوجو
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناة السورس', url="t.me/S_16_M"},
},
{
{text = 'مطور السورس', url="t.me/R_10bo"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/S_16_M&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{
{text = 'رعد 💌', url="t.me/R_10bo"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/R_10bo&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end



if text == 'العاب متطوره' or text == 'العاب جوجو' or text == 'الالعاب المتطوره' or text == 'العاب السورس' then
local Text =[[
𝘨𝘢𝘮𝘦𝘴 𝘱𝘳𝘰 ○'
...
{
{text = 'مطور السـورس', url="t.me/R_10bo"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'S_16_M')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'S_16_M')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'S_16_M')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'S_16_M')..') \n*تم قفـل الالعاب*\n')  
end,nil)   
...
if Get_info then
local TextS = "\n اهلا بك في متجر ملفات سورس جوجو\n ملفات السورس ↓\n*ٴ܀⠤⠤⠤⠤⠤⠤܀ٴ*●\n\n"
local TextE = "\n*ٴ܀⠤⠤⠤⠤⠤⠤܀ٴ*\n • علامة تعني { ✓ } ملف مفعل\n • علامة تعني { ✘ } ملف معطل\n • قناة سورس جوجو ↓\n".." • [𝙉𝙄𝙂𝙂𝘼 𝘾𝙃](t.me/S_16_M) \n"
local NumFile = 0
...
local name_t = {striDRG.match(text, "^(تعطيل) (.*)(.lua)$")}
...
send(msg.chat_id_, msg.id_," • عذرا الملف لايدعم سورس جوجو \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and SudoBot(msg) then
local name_t = {striDRG.match(text, "^(تفعيل) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("File_Bot/"..file,"r")
if file_bot then
io.close(file_bot)
...
send(msg.chat_id_, msg.id_,'•  𝐖𝐄𝐈𝐂𝐎𝐌𝐄 𝐆𝐎𝐆𝐎•\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
...
local UserName = (b.username_ or "S_16_M")
...
tdcli_function ({ ID = "ChaDRGeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
...
tdcli_function ({ ID = "ChaDRGeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'• ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
...
tdcli_function ({ ID = "ChaDRGeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'• ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
...
tdcli_function ({ ID = "ChaDRGeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
end
...
tdcli_function ({ ID = "ChaDRGeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'S_16_M')..')'
status  = '\n تم الغاء حظره من هنا'
texts = usertext..status
else
...
tdcli_function ({ ID = "ChaDRGeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'S_16_M')..') ~'
status  = '\n تم الغاء حظره من هنا'
...
local TextEnd = {striDRG.match(text, "^(كتم) (%d+) (.*)$")}
function start_function(extra, result, success)
...
local TextEnd = {striDRG.match(text, "^(تقيد) (%d+) (.*)$")}
function start_function(extra, result, success)
if TextEnd[3] == 'يوم' then
Time_Restrict = TextEnd[2]:match('(%d+)')
Time = Time_Restrict * 86400
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_chaDRGe_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_chaDRGe_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
else
send(msg.chat_id_, msg.id_, '• لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_chaDRGe_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_chaDRGe_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
else
send(msg.chat_id_, msg.id_, '• لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_chaDRGe_info=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=True")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_chaDRGe_info=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=True")
else
send(msg.chat_id_, msg.id_, '• لا يوجد حساب بهاذا المعرف')
end
end
...
if database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_, "flood") == "kick" then     
flood = 'بالطرد •'     
elseif database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"flood") == "keed" then     
flood = 'بالتقيد •'     
elseif database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"flood") == "mute" then     
flood = 'بالكتم •'           
elseif database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"flood") == "del" then     
flood = 'بالمسح •'           
else     
flood = '✘'     
end
...
NUM_MSG_MAX = database:hget(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_,"floodmax") or 0
local text = 
...
database:hset(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."floodiDRG:settiDRGs:"..msg.chat_id_ ,"floodtime" ,Num) 
...
database:set(bot_id..'ChaDRGe:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_,true) 
...
database:setex(bot_id.."CHEDRG:ID"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
> 
•يمكنك اضافة
• `#تعليق` تعليق الصوره
...
if database:get(bot_id.."CHEDRG:ID"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"•تم الغاء تعين الايدي") 
database:del(bot_id.."CHEDRG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."CHEDRG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
local CHEDRGER_ID = text:match("(.*)")  
database:set(bot_id.."KLISH:ID"..msg.chat_id_,CHEDRGER_ID)
...
local text1 = {striDRG.match(text, "^(رفع) (.*) @(.*)$")}
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n• العضو > ['..result.title_..'](t.me/'..(text1[3] or 'S_16_M')..')'..'\n تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local text1 = {striDRG.match(text, "^(تنزيل) (.*) @(.*)$")}
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'جوجو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'جوجو')
local DRAGON_Msg = {
'ۿۧهلا ؏ـمࢪي .',
'    اؤمرني',
'ۿۧاا قلبي .',
...
tdcli_function ({ ID = "ChaDRGeChatTitle",chat_id_ = msg.chat_id_,title_ = Name },function(arg,data) 
if data.message_ == "Channel chat title can be chaDRGed by administrators only" then
send(msg.chat_id_,msg.id_,"• البوت ليس ادمن يرجى ترقيتي !")  
return false  
end 
if data.message_ == "CHAT_ADMIN_REQUIRED" then
...
Textes = math.random(#textiDRG)
send(msg.chat_id_, msg.id_,textiDRG[Textes])
end
end
...
if not database:sismember(bot_id..'Spam:TextiDRG'..msg.sender_user_id_,text) then
...
database:sadd(bot_id..'Spam:TextiDRG'..msg.sender_user_id_,text) 
end
if stekr then 
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'جوجو').." غادر" or text == 'بوت غادر' then  
if Sudo(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
tdcli_function ({ID = "ChaDRGeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
...
tdcli_function({ID="ChaDRGeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=msg.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'• ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
...
tdcli_function ({ ID = "ChaDRGeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/S_16_M) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id.."numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = striDRG.match(text, "(%d+)") 
...
local txt = {striDRG.match(text, "^(قول) (.*)$")}
...
name = striDRG.gsub(name,'سحور','س ر و ح')
name = striDRG.gsub(name,'سياره','ه ر س ي ا')
name = striDRG.gsub(name,'استقبال','ل ب ا ت ق س ا')
name = striDRG.gsub(name,'قنفه','ه ق ن ف')
name = striDRG.gsub(name,'ايفون','و ن ف ا')
name = striDRG.gsub(name,'بزونه','ز و ه ن')
name = striDRG.gsub(name,'مطبخ','خ ب ط م')
name = striDRG.gsub(name,'كرستيانو','س ت ا ن و ك ر ي')
name = striDRG.gsub(name,'دجاجه','ج ج ا د ه')
name = striDRG.gsub(name,'مدرسه','ه م د ر س')
name = striDRG.gsub(name,'الوان','ن ا و ا ل')
name = striDRG.gsub(name,'غرفه','غ ه ر ف')
name = striDRG.gsub(name,'ثلاجه','ج ه ت ل ا')
name = striDRG.gsub(name,'كهوه','ه ك ه و')
name = striDRG.gsub(name,'سفينه','ه ن ف ي س')
name = striDRG.gsub(name,'العراق','ق ع ا ل ر ا')
name = striDRG.gsub(name,'محطه','ه ط م ح')
name = striDRG.gsub(name,'طياره','ر ا ط ي ه')
name = striDRG.gsub(name,'رادار','ر ا ر ا د')
name = striDRG.gsub(name,'منزل','ن ز م ل')
name = striDRG.gsub(name,'مستشفى','ى ش س ف ت م')
name = striDRG.gsub(name,'كهرباء','ر ب ك ه ا ء')
name = striDRG.gsub(name,'تفاحه','ح ه ا ت ف')
name = striDRG.gsub(name,'اخطبوط','ط ب و ا خ ط')
name = striDRG.gsub(name,'سلمون','ن م و ل س')
name = striDRG.gsub(name,'فرنسا','ن ف ر س ا')
name = striDRG.gsub(name,'برتقاله','ر ت ق ب ا ه ل')
name = striDRG.gsub(name,'تفاح','ح ف ا ت')
name = striDRG.gsub(name,'مطرقه','ه ط م ر ق')
name = striDRG.gsub(name,'بتيته','ب ت ت ي ه')
name = striDRG.gsub(name,'لهانه','ه ن ل ه ل')
name = striDRG.gsub(name,'شباك','ب ش ا ك')
name = striDRG.gsub(name,'باص','ص ا ب')
name = striDRG.gsub(name,'سمكه','ك س م ه')
name = striDRG.gsub(name,'ذباب','ب ا ب ذ')
name = striDRG.gsub(name,'تلفاز','ت ف ل ز ا')
name = striDRG.gsub(name,'حاسوب','س ا ح و ب')
name = striDRG.gsub(name,'انترنيت','ا ت ن ر ن ي ت')
name = striDRG.gsub(name,'ساحه','ح ا ه س')
name = striDRG.gsub(name,'جسر','ر ج س')
...
name = striDRG.gsub(name,'الجرس','شيئ اذا لمسته صرخ ما هوه ؟')
name = striDRG.gsub(name,'عقرب الساعه','اخوان لا يستطيعان تمضيه اكثر من دقيقه معا فما هما ؟')
name = striDRG.gsub(name,'السمك','ما هو الحيوان الذي لم يصعد الى سفينة نوح عليه السلام ؟')
name = striDRG.gsub(name,'المطر','شيئ يسقط على رأسك من الاعلى ولا يجرحك فما هو ؟')
name = striDRG.gsub(name,'5','ما العدد الذي اذا ضربته بنفسه واضفت عليه 5 يصبح ثلاثين ')
name = striDRG.gsub(name,'الكتاب','ما الشيئ الذي له اوراق وليس له جذور ؟')
name = striDRG.gsub(name,'البسمار','ما هو الشيئ الذي لا يمشي الا بالضرب ؟')
name = striDRG.gsub(name,'7','عائله مؤلفه من 6 بنات واخ لكل منهن .فكم عدد افراد العائله ')
name = striDRG.gsub(name,'الكعبه','ما هو الشيئ الموجود وسط مكة ؟')
name = striDRG.gsub(name,'بيت الشعر','ما هو البيت الذي ليس فيه ابواب ولا نوافذ ؟ ')
name = striDRG.gsub(name,'لهانه','وحده حلوه ومغروره تلبس مية تنوره .من هيه ؟ ')
name = striDRG.gsub(name,'انا','ابن امك وابن ابيك وليس باختك ولا باخيك فمن يكون ؟')
name = striDRG.gsub(name,'امي','اخت خالك وليست خالتك من تكون ؟ ')
name = striDRG.gsub(name,'الابره','ما هو الشيئ الذي كلما خطا خطوه فقد شيئا من ذيله ؟ ')
name = striDRG.gsub(name,'الساعه','ما هو الشيئ الذي يقول الصدق ولكنه اذا جاع كذب ؟')
name = striDRG.gsub(name,'22','كم مره ينطبق عقربا الساعه على بعضهما في اليوم الواحد ')
name = striDRG.gsub(name,'خطأ','ما هي الكلمه الوحيده التي تلفض خطأ دائما ؟ ')
name = striDRG.gsub(name,'كم الساعه','ما هو السؤال الذي تختلف اجابته دائما ؟')
name = striDRG.gsub(name,'البيتنجان','جسم اسود وقلب ابيض وراس اخظر فما هو ؟')
name = striDRG.gsub(name,'البيض','ماهو الشيئ الذي اسمه على لونه ؟')
name = striDRG.gsub(name,'المرايه','ارى كل شيئ من دون عيون من اكون ؟ ')
name = striDRG.gsub(name,'الضوء','ما هو الشيئ الذي يخترق الزجاج ولا يكسره ؟')
name = striDRG.gsub(name,'الهواء','ما هو الشيئ الذي يسير امامك ولا تراه ؟')
name = striDRG.gsub(name,'الضل','ما هو الشيئ الذي يلاحقك اينما تذهب ؟ ')
name = striDRG.gsub(name,'العمر','ما هو الشيء الذي كلما طال قصر ؟ ')
name = striDRG.gsub(name,'القلم','ما هو الشيئ الذي يكتب ولا يقرأ ؟')
name = striDRG.gsub(name,'المشط','له أسنان ولا يعض ما هو ؟ ')
name = striDRG.gsub(name,'الحفره','ما هو الشيئ اذا أخذنا منه ازداد وكبر ؟')
name = striDRG.gsub(name,'البحر','ما هو الشيئ الذي يرفع اثقال ولا يقدر يرفع مسمار ؟')
name = striDRG.gsub(name,'الثلج','انا ابن الماء فان تركوني في الماء مت فمن انا ؟')
name = striDRG.gsub(name,'الاسفنج','كلي ثقوب ومع ذالك احفض الماء فمن اكون ؟')
name = striDRG.gsub(name,'الصوت','اسير بلا رجلين ولا ادخل الا بالاذنين فمن انا ؟')
name = striDRG.gsub(name,'بلم','حامل ومحمول نصف ناشف ونصف مبلول فمن اكون ؟ ')
...
name = striDRG.gsub(name,'قرد','🐒')
name = striDRG.gsub(name,'دجاجه','🐔')
name = striDRG.gsub(name,'بطريق','🐧')
name = striDRG.gsub(name,'ضفدع','🐸')
name = striDRG.gsub(name,'بومه','🦉')
name = striDRG.gsub(name,'نحله','🐝')
name = striDRG.gsub(name,'ديك','🐓')
name = striDRG.gsub(name,'جمل','🐫')
name = striDRG.gsub(name,'بقره','🐄')
name = striDRG.gsub(name,'دولفين','🐬')
name = striDRG.gsub(name,'تمساح','🐊')
name = striDRG.gsub(name,'قرش','🦈')
name = striDRG.gsub(name,'نمر','🐅')
name = striDRG.gsub(name,'اخطبوط','🐙')
name = striDRG.gsub(name,'سمكه','🐟')
name = striDRG.gsub(name,'خفاش','🦇')
name = striDRG.gsub(name,'اسد','🦁')
name = striDRG.gsub(name,'فأر','🐭')
name = striDRG.gsub(name,'ذئب','🐺')
name = striDRG.gsub(name,'فراشه','🦋')
name = striDRG.gsub(name,'عقرب','🦂')
name = striDRG.gsub(name,'زرافه','🦒')
name = striDRG.gsub(name,'قنفذ','🦔')
name = striDRG.gsub(name,'تفاحه','🍎')
name = striDRG.gsub(name,'باذنجان','🍆')
...
name = striDRG.gsub(name,'باي','هلو')
name = striDRG.gsub(name,'فهمت','مافهمت')
name = striDRG.gsub(name,'موزين','زين')
name = striDRG.gsub(name,'اسمعك','ماسمعك')
name = striDRG.gsub(name,'احبك','ماحبك')
name = striDRG.gsub(name,'موحلو','حلو')
name = striDRG.gsub(name,'نضيف','وصخ')
name = striDRG.gsub(name,'حاره','بارده')
name = striDRG.gsub(name,'ناصي','عالي')
name = striDRG.gsub(name,'جوه','فوك')
name = striDRG.gsub(name,'سريع','بطيء')
name = striDRG.gsub(name,'ونسه','ضوجه')
name = striDRG.gsub(name,'طويل','قزم')
name = striDRG.gsub(name,'سمين','ضعيف')
name = striDRG.gsub(name,'ضعيف','قوي')
name = striDRG.gsub(name,'شريف','كواد')
name = striDRG.gsub(name,'شجاع','جبان')
name = striDRG.gsub(name,'رحت','اجيت')
name = striDRG.gsub(name,'عدل','ميت')
name = striDRG.gsub(name,'نشيط','كسول')
name = striDRG.gsub(name,'شبعان','جوعان')
name = striDRG.gsub(name,'موعطشان','عطشان')
name = striDRG.gsub(name,'خوش ولد','موخوش ولد')
name = striDRG.gsub(name,'اني','حمار')
name = striDRG.gsub(name,'هادئ','عصبي')
...
name = striDRG.gsub(name,'😸','😹😹😹😹😹😹😹•😸😹😹•😹')
name = striDRG.gsub(name,'☠','💀💀💀💀💀💀💀☠💀💀💀💀💀')
name = striDRG.gsub(name,'🐼','👻??👻🐼👻👻👻👻👻👻👻')
name = striDRG.gsub(name,'🐇','🕊🕊🕊🕊🕊🐇🕊🕊🕊🕊')
name = striDRG.gsub(name,'🌑','🌚🌚🌚🌚🌚🌑🌚🌚🌚')
name = striDRG.gsub(name,'🌚','🌑🌑🌑🌑🌑🌚🌑🌑🌑')
name = striDRG.gsub(name,'⭐️','🌟🌟🌟🌟🌟🌟🌟🌟⭐️🌟🌟🌟')
name = striDRG.gsub(name,'•','💫💫💫💫💫•💫💫💫💫')
name = striDRG.gsub(name,'⛈','🌨🌨🌨🌨🌨⛈🌨🌨🌨🌨')
name = striDRG.gsub(name,'🌥','⛅️⛅️⛅️⛅️⛅️⛅️🌥⛅️⛅️⛅️⛅️')
name = striDRG.gsub(name,'⛄️','☃☃☃☃☃☃⛄️☃☃☃☃')
name = striDRG.gsub(name,'👨‍🔬','👩‍🔬👩‍🔬👩‍🔬👩‍🔬👩‍🔬??‍🔬👩‍🔬👩‍🔬👨‍??👩‍🔬👩‍🔬👩‍🔬')
name = striDRG.gsub(name,'•','👩‍💻👩‍💻👩‍‍💻👩‍‍💻👩‍💻•👩‍💻👩‍💻??‍💻')
name = striDRG.gsub(name,'👨‍🔧','👩‍🔧👩‍🔧👩‍🔧👩‍🔧👩‍🔧👩‍🔧👨‍🔧👩‍🔧')
...
name = striDRG.gsub(name,'🧝‍♂','🧝‍♀🧝‍♀🧝‍♀🧝‍♀🧝‍♀🧝‍♂🧝‍♀🧝‍♀🧝‍♀')
name = striDRG.gsub(name,'🙍‍♂️','🙎‍♂️🙎‍♂️🙎‍♂️🙎‍♂️•‍♂️🙍‍♂️🙎‍♂️🙎‍♂️🙎‍♂️')
name = striDRG.gsub(name,'🧖‍♂️','🧖‍♀️🧖‍♀️🧖‍♀️🧖‍♀️🧖‍♀️🧖‍♂️🧖‍♀️🧖‍♀️🧖‍♀️🧖‍♀️')
name = striDRG.gsub(name,'👬','👭👭👭👭👭👬👭👭👭')
name = striDRG.gsub(name,'👨‍👨‍👧','👨‍👨‍👦👨‍👨‍👦👨‍👨‍??👨‍👨‍👦👨‍👨‍👧👨‍👨‍👦👨‍👨‍👦')
name = striDRG.gsub(name,'🕒','🕒🕒🕒🕒🕒🕒🕓🕒🕒🕒')
name = striDRG.gsub(name,'🕤','🕥🕥🕥🕥🕥🕤🕥🕥🕥')
...
name = striDRG.gsub(name,'9','2+7=')
name = striDRG.gsub(name,'2','5-3=')
name = striDRG.gsub(name,'60','(30)² =')
name = striDRG.gsub(name,'9','2+2+5=')
name = striDRG.gsub(name,'5','8-3=?')
name = striDRG.gsub(name,'4','40÷10=')
name = striDRG.gsub(name,'25','30-5=')
name = striDRG.gsub(name,'10','100÷10=')
name = striDRG.gsub(name,'17','10+5+2=')
name = striDRG.gsub(name,'15','25-10=')
name = striDRG.gsub(name,'39','44-5=')
name = striDRG.gsub(name,'5','12+1-8=')
name = striDRG.gsub(name,'16','16+16-16=')
...
name = Hussein[math.random(#Hussein)]
database:del(bot_id..'Set:EDRGlish:Bot'..msg.chat_id_)
database:set(bot_id..':Set:EDRGlish'..msg.chat_id_,name)
name = striDRG.gsub(name,'ذئب','Wolf')
name = striDRG.gsub(name,'معلومات','Information')
name = striDRG.gsub(name,'قنوات','Channels')
name = striDRG.gsub(name,'مجموعات','Groups')
name = striDRG.gsub(name,'كتاب','Book')
name = striDRG.gsub(name,'تفاحه','Apple')
name = striDRG.gsub(name,'سدني','Sydney')
name = striDRG.gsub(name,'نقود','money')
name = striDRG.gsub(name,'اعلم','I know')
name = striDRG.gsub(name,'تمساح','crocodile')
name = striDRG.gsub(name,'مختلف','Different')
name = striDRG.gsub(name,'ذكي','Intelligent')
send(msg.chat_id_, msg.id_,'اجب عن التالي ~ { '..name..' }')
return false
end
end
------------------------------------------------------------------------
if text == ''..(database:get(bot_id..':Set:EDRGlish'..msg.chat_id_) or '')..'' then 
if not database:get(bot_id..'Set:EDRGlish:Bot'..msg.chat_id_) then 
database:del(bot_id..':Set:EDRGlish'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'•┇ الف مبروك لقد فزت \n•┇ للعب مره اخره ارسل ←{ `انكليزي` }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id..'Set:EDRGlish:Bot'..msg.chat_id_,true)
end
------------------------------------------------------------------------
if text == 'امثله' then
if AddChannel(msg.sender_user_id_) == false then
...
name = striDRG.gsub(name,'جوز','ينطي____للماعده سنون')
name = striDRG.gsub(name,'ضراطه','الي يسوق الحمار يتحمل___')
name = striDRG.gsub(name,'بيدك','اكل___محد يفيدك')
name = striDRG.gsub(name,'الحافي','تجدي من___نعال')
name = striDRG.gsub(name,'شقره','مع الخيل يا___')
name = striDRG.gsub(name,'النخله','الطول طول___والعقل عقل الصخلة')
name = striDRG.gsub(name,'سلايه','بالوجه امراية وبالظهر___')
name = striDRG.gsub(name,'الخيل','من قلة___شدو على الچلاب سروج')
name = striDRG.gsub(name,'حداد','موكل من صخم وجهه كال اني___')
name = striDRG.gsub(name,'المبلل','___ما يخاف من المطر')
name = striDRG.gsub(name,'الحبل','اللي تلدغة الحية يخاف من جرة___')
name = striDRG.gsub(name,'يركص','المايعرف___يقول الكاع عوجه')
name = striDRG.gsub(name,'العنب','المايلوح___يقول حامض')
name = striDRG.gsub(name,'العمه','___إذا حبت الچنة ابليس يدخل الجنة')
name = striDRG.gsub(name,'الخبز','انطي___للخباز حتى لو ياكل نصه')
name = striDRG.gsub(name,'باحصاد','اسمة___ومنجله مكسور')
name = striDRG.gsub(name,'شهر','امشي__ولا تعبر نهر')
name = striDRG.gsub(name,'شكه','يامن تعب يامن__يا من على الحاضر لكة')
name = striDRG.gsub(name,'القرد','__بعين امه غزال')
name = striDRG.gsub(name,'يكحله','اجه___عماها')
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [𝐆𝐎𝐆𝐎 - SoUrCe](https://t.me/S_16_M)
]]
...
tdcli_function ({ID="SendMessage", chat_id_=msg.chat_id_, reply_to_message_id_=msg.id_, disable_notification_=0, from_background_=1, reply_markup_=nil, input_message_content_={ID="InputMessageText", text_=text, disable_web_page_preview_=1, clear_draft_=0, entities_={[0] = {ID="MessageEntityMentionName", offset_=0, leDRGth_=19, user_id_=id}}}}, dl_cb, nil)
end

if text == "اي رايك في ده" or text == "ايه رايك في ده" or text == "اي رايك ف ده" then
local textiDRG = {"܁•قلبي اوي دا 🦄💞","܁•   كيوت فشخخخ 🥺💞","܁•اكتر شخص بحبه🥺💞","متوحد 😹💞.","܁•   قلبي دا اوعا حد يكلمو 😚💌"}
send(msg.chat_id_, msg.id_, ''..textiDRG[math.random(#textiDRG)]..'')
return false
end
if text == "نسبه الحب" or text == "نسبه حب" or text == "شكد الحب" then
local textiDRG = {"7%","100%"," 80%","70%","0%","50%","10%","99%","000 حب زربا"}
send(msg.chat_id_, msg.id_, ''..textiDRG[math.random(#textiDRG)]..'')
return false
end
if text == "نسبه الرجوله" or text == "نسبه الانوثه" or text == "رجال لو مره" then
local textiDRG = {"7%","100%"," 80%","70%","0%","50%","10%","99%","10000%"}
send(msg.chat_id_, msg.id_, ''..textiDRG[math.random(#textiDRG)]..'')
return false
end
if text == "هينه" or text == "رزله" then
local textiDRG = {" مبهينش حيوانات😂😂","ايه يخول انت مزعلو ليه","لو جيت جمبه هزعلك مني فل!! ","عايز اي متوحد انت","سيبك منو دا متخلف 😂💔","ده واطى وندلل فكك منو 😂💔","دا جربان اهين مين😂😂😂😂 😂💔"}
send(msg.chat_id_, msg.id_, ''..textiDRG[math.random(#textiDRG)]..'')
return false
end
if text == "مصه" or text == "بوسه" then
local textiDRG = {"امووووووووواحح😘💕","استغفر الله فاسق 😒","الوجه ميساعد 😐✋","ببوس حريم بس😌😹","خدك نضيف!؟ 😂","تدفع كام! 🌝","طب خليه يستحمي اول 🙊😂","كل شويه بوسه بوسه 😏","مش بايس حد انا فل!! ","امموووواه لعيونك ي جميل 💎💗😹"}
send(msg.chat_id_, msg.id_, ''..textiDRG[math.random(#textiDRG)]..'')
return false
end
...
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if text and not database:sismember(bot_id..'Spam:TextiDRG'..msg.sender_user_id_,text) then
database:del(bot_id..'Spam:TextiDRG'..msg.sender_user_id_) 
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = getChatId(msg.chat_id_).ID,filter_ = {ID = "ChannelMembersBots"},offset_ = 0,limit_ = 100 },function(arg,tah) local admins = tah.members_ for i=0 , #admins do if tah.members_[i].status_.ID ~= "ChatMemberStatusEditor" and not is_mod(msg) then tdcli_function ({ID = "ChaDRGeChatMemberStatus",chat_id_ = msg.chat_id_,user_id_ = admins[i].user_id_,status_ = {ID = "ChatMemberStatusKicked"},}, function(arg,f) end, nil) end end end,nil)  
end
end     
end
end
...
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatDeletePhoto" or msg.content_.ID == "MessageChatChaDRGePhoto" or msg.content_.ID == 'MessagePinMessage' or msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" or msg.content_.ID == 'MessageChatChaDRGeTitle' or msg.content_.ID == "MessageChatDeleteMember" then   
if database:get(bot_id..'lock:tagservr'..msg.chat_id_) then  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false
end    
...
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](T.ME/S_16_M)}\n•["..DRAGONAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
...
tdcli_function ({ID = "ChaDRGeChatMemberStatus",chat_id_=v,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'Chek:Groups',v)  
end
